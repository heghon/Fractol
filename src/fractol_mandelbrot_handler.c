...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/11 14:14:14 by bmenant           #+#    #+#             */
/*   Updated: 2019/06/14 11:31:41 by bmenant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/fractol.h"

static void	mandelbrot_calculations(t_data *data)
{
	data->n = -1;
				...
				+ data->c[IM] * data->c[IM]) < 4)
	{
		...
		data->c[RE] = data->b[RE] + data->tmp_c[RE];
		data->c[IM] = data->b[IM] + data->tmp_c[IM];
	}
}
